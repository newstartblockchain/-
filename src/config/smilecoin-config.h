/* src/config/smilecoin-config.h.  Generated from smilecoin-config.h.in by configure.  */
/* src/config/smilecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef smilecoin_CONFIG_H

#define smilecoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/smilecoinpay/smilecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "smilecoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "smilecoin Core 1.0.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "smilecoincore"
