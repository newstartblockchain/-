...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "smilecoinNetwork") type = smilecoinNetwork;
    if(strType == "smilecoinNetworkVariable") type = smilecoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == smilecoinNetwork) s = "smilecoinNetwork";
    if(type == smilecoinNetworkVariable) s = "smilecoinNetworkVariable";
