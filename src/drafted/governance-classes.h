 ...
 *
 *   // network
 *   CsmilecoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.smilecoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CsmilecoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CsmilecoinNetwork(UniValue objIn)
    {
...
// // can be under: smilecoinNetwork
// //   -- signature requirements : Key1(User)
// class CsmilecoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == smilecoinNetwork);
//     // }
