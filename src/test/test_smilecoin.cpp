...
#define BOOST_TEST_MODULE smilecoin Test Suite

#include "test_smilecoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_smilecoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
