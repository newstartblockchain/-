    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("smilecoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a smilecoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and smilecoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About smilecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about smilecoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for smilecoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your smilecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified smilecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a smilecoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the smilecoin Core help message to get a list with possible smilecoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("smilecoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to smilecoin network", "", count));
    } else {
...
{
    QString strTitle = tr("smilecoin Core"); // default title
    ...
    // Append title to "smilecoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
