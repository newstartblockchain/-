    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("smilecoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About smilecoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  smilecoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the smilecoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SML, 0.1 SML, 1 SML and 10 SML -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://smilecoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://smilecoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("smilecoin Core is shutting down...") + "<br /><br />" +
