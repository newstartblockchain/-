    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SML-light"), QVariant("light"));
    ui->theme->addItem(QString("SML-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SML-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SML-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SML-traditional"), QVariant("trad"));
