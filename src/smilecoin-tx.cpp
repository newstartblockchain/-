...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("smilecoin Core smilecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  smilecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded smilecoin transaction") + "\n" +
              "  smilecoin-tx [options] -create [commands]   " + _("Create hex-encoded smilecoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded smilecoin transaction
