...
Only requiring some minor changes is smilecoin.cpp.
...
Changes to smilecoin.cpp
----------------------
smilecoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
