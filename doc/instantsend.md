...
This mechanism has been integrated into Bitcore-Node-smilecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/smilecoinpay/insight-api-smilecoin#web-socket-api](https://github.com/smilecoinpay/insight-api-smilecoin#web-socket-api)
* API: [https://github.com/smilecoinpay/insight-api-smilecoin#instantsend-transactions](https://github.com/smilecoinpay/insight-api-smilecoin#instantsend-transactions)
...
By default, the smilecoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the smilecoin Core daemon:
