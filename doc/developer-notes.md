...
smilecoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as smilecoin Core, where everyone uses
...
pay attention to for reviewers of smilecoin Core code.

General smilecoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: smilecoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
