...
pkgdatadir = $(datadir)/smilecoincore
pkgincludedir = $(includedir)/smilecoincore
pkglibdir = $(libdir)/smilecoincore
pkglibexecdir = $(libexecdir)/smilecoincore
...
CONFIG_HEADER = $(top_builddir)/src/config/smilecoin-config.h
CONFIG_CLEAN_FILES = libsmilecoinconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libsmilecoinconsensus.pc.in \
	...
	$(top_srcdir)/src/config/smilecoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/smilecoin/Desktop/sml2.0/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/smilecoin/Desktop/sml2.0/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/smilecoin/Desktop/sml2.0/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/smilecoin/Desktop/sml2.0/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/smilecoin/Desktop/sml2.0/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = smilecoincore
PACKAGE_BUGREPORT = https://github.com/smilecoinpay/smilecoin/issues
PACKAGE_NAME = smilecoin Core
PACKAGE_STRING = smilecoin Core 1.0.3
PACKAGE_TARNAME = smilecoincore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/smilecoin/Desktop/sml2.0
abs_srcdir = /home/smilecoin/Desktop/sml2.0
abs_top_builddir = /home/smilecoin/Desktop/sml2.0
abs_top_srcdir = /home/smilecoin/Desktop/sml2.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/smilecoin/Desktop/sml2.0/build-aux/install-sh
...
pkgconfig_DATA = libsmilecoinconsensus.pc
BITCOIND_BIN = $(top_builddir)/src/smilecoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/smilecoin-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/smilecoin-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = smilecoin-Qt.app
OSX_DMG = smilecoin-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_smilecoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_smilecoin_coverage.info test_smilecoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/smilecoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/smilecoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/smilecoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/smilecoin-config.h
$(top_srcdir)/src/config/smilecoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/smilecoin-config.h src/config/stamp-h1
libsmilecoinconsensus.pc: $(top_builddir)/config.status $(srcdir)/libsmilecoinconsensus.pc.in
...
$(OSX_APP)/Contents/MacOS/smilecoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/smilecoin-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "smilecoin-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/smilecoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_smilecoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_smilecoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_smilecoin_filtered.info: test_smilecoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_smilecoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_smilecoin_filtered.info
...
#test_smilecoin_coverage.info: baseline_filtered_combined.info test_smilecoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_smilecoin_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_smilecoin_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_smilecoin_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_smilecoin.coverage/.dirstamp:  test_smilecoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_smilecoin.coverage/.dirstamp total.coverage/.dirstamp

# smilecoin: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_smilecoin.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
